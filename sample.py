...
img_list = ['Iris_setosa.jpg','iris_virginica_.jpg','iris_versicolor.jpg']
...
if st.button("Predict"):
  ...
  if species_type == 'Iris-setosa':
    st.image(img_list[0],'Iris-Setosa')

  if species_type == 'Iris-virginica':
    st.image(img_list[1],'Iris-Virginica')
  
  if species_type == 'Iris-versicolor':
    st.image(img_list[2],'Iris-Versicolor')
